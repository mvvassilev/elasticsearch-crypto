...
default_optional_args = {'crypto_types':'', 'json_format':0}

args = get_glue_args(mandatory_fields, default_optional_args)
data_src_url = args['data_src_url']
ES_IP = args['ES_IP']
ES_index = args['ES_index']
crypto_types = args['crypto_types']
json_format = args['json_format']
# data_src_url = "https://www.cryptodatadownload.com/cdd/"
# ES_IP = 'http://3.89.129.252:9200'
# ES_index = 'crypto_index'
# crypto_types = 'AAVE/USDT, ADA/BTC, ADA/USDT, ALGO/USDT'
# json_format = ''
...
if crypto_types:
    urls = []
    crypto_types_list = (crypto_types.replace(" ", "")).split(',')
    for type in crypto_types_list:
        # filename: for example,  Binance_BTCGBP_d.csv
        urls.append(data_src_url + "_".join(["Binance", type.replace("/", ""), "d.csv"]))
elif json_format:
